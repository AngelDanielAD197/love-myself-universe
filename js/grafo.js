...
const universoCartas = {
    ...
    'wings-outro': {
        ...
        texto: "<p>Enero de 2026. Mensaje de cierre para Diana tras meses de redacción y meditación. Un registro de gratitud a mi yo del pasado que resistió sin saber por qué. <em>'Sigue adelante, incluso cuando tengas miedo.'</em></p>"
    },
    ...
    'rumbos-univ': {
        ...
        texto: "<p>La inmersión total en las Matemáticas Aplicadas, la Computación, la Inteligencia Artificial y el reencuentro con la propia esencia desde la perspectiva de la adultez académica.</p>"
    }
};
